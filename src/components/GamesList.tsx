...
import type { Game, GamesList as GamesListType } from '../types/game';
import GameCard from './GameCard';
import { getAllGames } from '../data/games'; // 从games.js导入
...
const GamesList: React.FC = () => {
  ...
  useEffect(() => {
    // 从games.js获取游戏数据
    const loadedGames = getAllGames() as GamesListType;
